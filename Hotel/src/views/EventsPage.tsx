      ...
      <main className="bg-[var(--bg-light)] text-[var(--text-main)]">
        ...
        >
          ...
          <div className="relative z-10 container-custom py-20">
            <div className="bg-[var(--main-card)] backdrop-blur-sm p-10 max-w-lg rounded-sm shadow-[var(--card-shadow)]">
              <h1
                className="font-bold leading-tight mb-4 text-[var(--text-main)]"
              ...
              <Link to="/reserve-event-room" className="btn-primary-ghost text-[var(--text-main)] border-[var(--text-main)] hover:bg-[var(--text-main)] hover:text-white text-xs tracking-widest uppercase px-6 py-3">
        ...
        <section className="relative py-0">
          ...
          <div className="relative min-h-[520px] overflow-hidden">
            ...
            <div className="relative z-10 h-full flex items-center container-custom py-20">
              <div
                className="bg-[var(--main-card)] backdrop-blur-sm p-10 max-w-xs rounded-sm shadow-[var(--card-shadow)]"
              >
                <h2
